...
void SDL3AudioManager::initialize(const std::string& basePath) {
    mBasePath = basePath;
...
void SDL3AudioManager::loadSound(const std::string& filePath) {
    if (!mInitialized) {
...
void SDL3AudioManager::playSound(const std::string& soundName) {
    if (!mInitialized) {
...
void SDL3AudioManager::stopSound(const std::string& soundName) {
    if (!mInitialized) {
...
void SDL3AudioManager::setVolume(float volume) {
    if (!mInitialized) {
...
void SDL3AudioManager::loadMusic(const std::string& filePath) {
    if (!mInitialized) {
...
void SDL3AudioManager::playMusic() {
    if (!mInitialized) {
...
void SDL3AudioManager::pauseMusic() {
    if (!mInitialized) {
...
void SDL3AudioManager::stopMusic() {
    if (!mInitialized) {
...
void SDL3AudioManager::setMusicVolume(float volume) {
    if (!mInitialized) {
